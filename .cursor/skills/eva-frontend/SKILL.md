...
Constructor SoT is the FSM (`states[]`). UI: FsmCanvas + SkillInspector.  
Canvas geometry (orthogonal routing, obstacles, labels): `docs/FSM_CANVAS_GEOMETRY.md`, code `features/skills/utils/geometry/`.
