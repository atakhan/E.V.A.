...
function loadEditorState() {
  ...
  editorState.value = {
    ...
    flowDirection: value.flowDirection ?? "vertical",
  };
...
function onAutoLayout() {
  canvasRef.value?.applyAutoLayout();
}
  ...
  <div v-if="skill" class="relative flex min-h-0 flex-1">
    <div class="relative min-h-0 min-w-0 flex-1">
      ...
      <CanvasToolbar
        ...
        :flow-direction="editorState.flowDirection ?? 'vertical'"
        @update:flow-direction="editorState.flowDirection = $event"
